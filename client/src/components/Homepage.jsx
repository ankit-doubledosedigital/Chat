...
import macIcon from '../Assets/ios-icon.png'; // Corrected to mac-icon.png
import windowsIcon from '../Assets/windows-icon.png';
import linuxIcon from '../Assets/linux-icon.png';
import './Style/Homepage.css'; // Ensure custom CSS file exists
  ...
  return (
    <>
      ...
      <section className="container my-5 content-width feature-section">
        <h2 className="h1 text-center mb-4">What We Can Do</h2>
        <div className="row text-center">
          <div className="col-md-4 mb-4">
            <div className="card shadow-sm border-0 feature-card">
              <div className="card-body">
                <h5 className="card-title text-secondary">Feature 1</h5>
                <p className="card-text text-muted">Description of what feature 1 does. This feature helps you achieve specific goals.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="card shadow-sm border-0 feature-card">
              <div className="card-body">
                <h5 className="card-title text-secondary">Feature 2</h5>
                <p className="card-text text-muted">Description of what feature 2 does. This feature provides additional functionality.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="card shadow-sm border-0 feature-card">
              <div className="card-body">
                <h5 className="card-title text-secondary">Feature 3</h5>
                <p className="card-text text-muted">Description of what feature 3 does. This feature enhances your overall experience.</p>
              </div>
            </div>
          </div>
        </div>
